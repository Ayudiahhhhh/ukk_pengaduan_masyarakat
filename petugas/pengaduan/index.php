                                            ...
                                            <form action="" method="post">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                            <textarea class="form-control" name="tanggapan_value" id="tanggapan" rows="13" required<?= ($d['status'] == 'selesai' || $d['status'] == 'ditolak') ? 'disabled' : ''; ?>><?= isset($tg[0]['tanggapan']) ? $tg[0]['tanggapan'] : ""; ?></textarea>
                                                            </div>
